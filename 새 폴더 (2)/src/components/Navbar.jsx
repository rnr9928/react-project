...
import {selectTotal, setOpenCart} from '../app/CartSlice.js';
    ...
    return (
        <> < header className = {
            !navState
                ...
                : 'fixed top-0 left-0 right-0 h-[9vh] flex items-center justify-center opacity-10' +
                        '0 z-[200] blur-effect-theme'
        } > <nav className='flex items-center justify-between teemo-Main'>
                    ...
                    <button
                        ...
                        <div
                            className={`absolute top-4 right-0 shadow w-4 h-4 text-[0.65rem] leading-tight font-medium rounded-full flex items-center justify-center cursor-pointer hover:scale-110 transition-all duration-300 ${navState
                                ...
                                : 'bg-slate-100 text-slate-900 shadow-slate-100'}`}>{total}</div>
                    </button>
                </li>
            </ul>
        </nav>
