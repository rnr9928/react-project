...
const Detail = ({
    ...
    return (
        <> < div className = {
            `flex items-center justify-between lg:flex-col lg:justify-center teemo-Main ${ifExists
                ? 'flex-row-reverse'
                : 'flex-row'}`
        } > <div
            ...
            <h1
                className='text-5xl lg:text-4xl md:text-3xl sm:text-2xl font-bold text-slate-900 filter drop-shadow-lg'>{title}</h1>
